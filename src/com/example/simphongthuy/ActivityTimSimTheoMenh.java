...
public class ActivityTimSimTheoMenh extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String title = mMenhModelData.returnTenMenh(mModelTimSim.getLoaiMenh())
				.getName();
		...
		// xử lý sự kiện click on list item => gọi activity đặt sim
		lv_show_sim
		...
		Thread thCon = new Thread(new Runnable() {
			...
			public void run() {
				...
				params.add(new BasicNameValuePair("provider", mModelTimSim
						.getLoaiMang()));
				params.add(new BasicNameValuePair("element", mModelTimSim
						.getLoaiMenh()));
