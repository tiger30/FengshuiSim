...
import model.MangModel;
import model.MangModelData;
...
public class FragmentSimPhongThuy extends Fragment {
	...
	MangModelData mMangModelData = new MangModelData();
	ArrayList<MangModel> mArrMang = mMangModelData.getArrMang();
	
	
	ArrayAdapter<MangModel> mAdapterMang = null;

	// cặp đối tượng dùng cho Spinner
	ArrayList<PriceModel> mArrPrice = new ArrayList<PriceModel>();
	ArrayAdapter<PriceModel> mAdapterPrice = null;

	MangModel mMangModelSelected;
	...
	private void loadForm() {
		...
		mAdapterMang = new ArrayAdapter<MangModel>(getActivity(),
